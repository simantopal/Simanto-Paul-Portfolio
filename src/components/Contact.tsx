...
export default function Contact() {
  return (
    <section className="py-20 px-8 bg-bg-primary relative overflow-hidden" id="contact">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-2">
            <label className="text-label-sm text-text-muted px-1">Your Message</label>
            <textarea
...
function InputField({ label, placeholder, type = "text" }: any) {
  return (
    <div className="space-y-2">
      <label className="text-label-sm text-text-muted px-1">{label}</label>
      <input
        type={type}
